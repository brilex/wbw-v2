...
const STATS = [
  { value: '20+', label: 'Years of firm experience' },
  { value: 'Custom', label: 'WordPress theme' },
  { value: 'Multi-sector', label: 'Client industries' },
  { value: 'CRA-ready', label: 'Compliance content' },
];

const SOLUTIONS = [
  'Custom WordPress theme — professional, trust-building design for a financial audience',
  'Service pages by offering — tax planning, payroll, advisory, CRA representation',
  'Industry-specific content — retail, trades, healthcare, and technology sectors served',
  'Clear calls to action — booking a consultation is never more than a click away',
  'Copywriting that builds authority — 20+ years of experience communicated clearly',
  'Fast-loading, mobile-friendly pages — clients checking on the go get a smooth experience',
  'SEO foundations — meta tags, structured headings, and clean URLs throughout',
  'Easy content management — the team updates service info without developer help',
];

const TECH = [
  { name: 'WordPress', desc: 'CMS powering the full site' },
  { name: 'Custom theme', desc: 'Hand-built for a financial services audience' },
  { name: 'Contact forms', desc: 'Consultation booking flow' },
];

export function CaseStudyJaberson() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
            ...
            <p className="text-xl text-zinc-600 leading-relaxed max-w-2xl mb-4">
              An Edmonton-based tax and accounting firm with 20+ years of
              experience serving small and mid-sized businesses — from tax
              planning and payroll to CRA representation.
            </p>
      ...
      <section className="pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            <Image src="/jaberson.webp" alt="Jaberson & Associates website" fill className="object-contain" priority />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl font-bold text-zinc-950 mb-6">A financial firm's site has to earn trust in seconds</h2>
              <p className="text-zinc-600 leading-relaxed mb-4">
                When a business is choosing who handles their taxes and
                compliance, the website is often the first — and sometimes only
                — signal of competence before they book a call.
              </p>
              <p className="text-zinc-600 leading-relaxed mb-4">
                Jaberson & Associates serves a genuinely broad client base — from
                online retailers to auto body shops to healthcare clinics — and
                needed a site that spoke to each of those audiences without
                feeling generic.
              </p>
              <p className="text-zinc-600 leading-relaxed">
                The firm also needed a clear content structure for its full range
                of services: tax planning, payroll, advisory, CRA representation,
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              {[
                'Professional, trust-building design for a financial audience',
                'Clear service pages for every offering',
                'Industry-specific messaging for diverse client sectors',
                'Simple consultation booking flow',
                '20+ years of experience communicated credibly',
                'Easy for the firm to update without a developer',
              ].map((req) => (
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
            ...
            <p className="text-xl text-zinc-600 max-w-2xl">
              We built a custom WordPress theme structured around Jaberson's
              actual services and client industries, not a stock accounting
              firm template.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">Need a website that builds instant credibility?</h2>
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              We build websites for accounting, finance, and professional
              services firms that need to earn trust before the first call.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="https://jaberson.com" target="_blank" rel="noopener noreferrer"
