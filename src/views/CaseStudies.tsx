...
export function CaseStudies() {
  const caseStudies: CaseStudy[] = [
    ...
    },
    {
      ...
      description: 'A windshield repair and replacement service site built for urgent, high-intent searches — fast, mobile-first, and focused on getting customers to a quote quickly.',
      results: [{ metric: 'Focus', value: 'Quote-first' }, { metric: 'Design', value: 'Mobile-first' }, { metric: 'Theme type', value: 'Custom' }],
