...
export function CaseStudies() {
  const caseStudies: CaseStudy[] = [
    ...
    },
    {
      ...
      description:
        "Built an automated conversion engine that transforms Vite + React projects (Bolt.new, Lovable, v0 exports) into production-ready Next.js 15 App Router apps — solving the SEO invisibility problem of AI-generated websites in under 60 seconds.",
      results: [
    ...
    },
    {
      ...
      category: "WordPress Website Redesign · SEO",
      description:
        "Complete website overhaul for a joinery company in Bosnia & Herzegovina — modern design, full SEO optimisation, and conversion-focused forms that landed the first paying customer within a week of launch.",
      results: [
    ...
    },
    {
      ...
      description:
        "Custom WordPress theme for one of Bosnia's leading packaging manufacturers — trilingual (BA/EN/DE), Figma-to-code, with product catalogue and factory gallery.",
      results: [
        { metric: "Languages", value: "3" },
        { metric: "Theme type", value: "Custom" },
        { metric: "Design source", value: "Figma" },
      ],
    ...
    },
    {
      ...
      description:
        "A premium agency website for a backlinks and AI citation engineering company — with interactive SEO audit tools, 3D data visualisations, and a conversion-focused strategy session booking flow.",
      results: [
        { metric: "Built-in tools", value: "2" },
        { metric: "Visual style", value: "3D Data" },
        { metric: "Conversion goal", value: "Bookings" },
      ],
    ...
    },
    {
      ...
      description:
        "Custom WordPress theme for an ISO-accredited laboratory in Tuzla — covering lab analysis, DDD services, workplace safety, and fire protection across four business sectors.",
      results: [
        { metric: "Sectors", value: "4" },
        { metric: "Theme type", value: "Custom" },
        { metric: "Accredited", value: "ISO" },
      ],
    ...
    },
    {
      ...
      description:
        "Website for an Edmonton-based renovation and construction contractor — painting, drywall, kitchen and bathroom remodeling — built to turn quote requests into booked jobs.",
      results: [
        { metric: "Years in business", value: "25+" },
        { metric: "Projects completed", value: "500+" },
        { metric: "Location", value: "Edmonton, AB" },
      ],
      color: "from-orange-500 to-orange-700",
      tags: ["WordPress", "Lead Capture", "Construction"],
      href: "/work/superedge",
      image: "/Superedge.webp",
    },
    {
      title: "One Auto Glass",
      client: "Auto Glass Services",
      category: "Custom WordPress · Automotive",
      description:
        "A windshield repair and replacement service site built for urgent, high-intent searches — fast, mobile-first, and focused on getting customers to a quote quickly.",
      results: [
        { metric: "Focus", value: "Quote-first" },
        { metric: "Design", value: "Mobile-first" },
        { metric: "Theme type", value: "Custom" },
      ],
      color: "from-indigo-500 to-indigo-700",
      tags: ["WordPress", "Custom Theme", "Automotive"],
      href: "/work/one-auto-glass",
      image: "/oneuatoglass.webp",
    },
    {
      ...
      description:
        "Website for an Edmonton tax and accounting firm with 20+ years of experience — clear service pages, industry-specific messaging, and a straightforward consultation booking flow.",
      results: [
        { metric: "Years of experience", value: "20+" },
        { metric: "Theme type", value: "Custom" },
        { metric: "Location", value: "Edmonton, AB" },
      ],
    ...
    },
    {
      ...
      description:
        "A Canada-wide business directory platform — 25+ categories, location-based search, and review features, built on custom directory architecture that scales.",
      results: [
        { metric: "Categories", value: "25+" },
        { metric: "Coverage", value: "Canada-wide" },
        { metric: "Search", value: "Geolocation" },
      ],
    ...
    },
    {
      ...
      description:
        "Website for a humanitarian organization delivering emergency relief, clean water, and education programs worldwide — structured around programs and time-sensitive crisis appeals.",
      results: [
        { metric: "Founded", value: "2014" },
        { metric: "Reach via partners", value: "90+ countries" },
        { metric: "Theme type", value: "Custom" },
      ],
    ...
    },
    {
      ...
      description:
        "An automated cryptocurrency news aggregator — Feedzy RSS integration pulls in fresh content automatically, with a fast, scannable layout built for headline-skimming readers.",
      results: [
        { metric: "Content updates", value: "Automated" },
        { metric: "Builder", value: "Bricks" },
        { metric: "RSS engine", value: "Feedzy" },
      ],
      ...
      <section className="py-20 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-16">
          {caseStudies.map((study, index) => (
            ...
            >
              <div
                className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? "lg:[&>*:first-child]:order-last" : ""}`}
              >
                {/* Visual */}
                <div className="relative aspect-[4/3] lg:aspect-auto overflow-hidden">
                  {study.image ? (
                    ...
                    <>
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${study.color} group-hover:scale-105 transition-transform duration-700`}
                      />
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  {study.href ? (
                    <Link href={study.href}>
                      <h2 className="text-3xl font-bold text-zinc-950 mb-1 group-hover:text-blue-600 transition-colors hover:text-blue-600">
                        {study.title}
                      </h2>
                    </Link>
                  ) : (
                    <h2 className="text-3xl font-bold text-zinc-950 mb-1 group-hover:text-blue-600 transition-colors">
                      {study.title}
                    </h2>
                  )}
                  <p className="text-sm text-zinc-500 mb-4">{study.category}</p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {study.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 bg-zinc-100 text-zinc-700 text-xs font-medium rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              Let's talk about how we can help drive real outcomes for your
              business.
            </p>
            <Link
              href="/contact"
