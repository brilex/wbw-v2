        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            ...
            <p className="text-xl text-zinc-600 leading-relaxed">
              Every industry has its own language, audiences, and KPIs. Explore
              how we tailor our approach to deliver exceptional results in your
              vertical.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <motion.div
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              We work across many more verticals. Let's talk about your project.
            </p>
            <Link
              href="/contact"
