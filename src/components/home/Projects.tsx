...
export function Projects() {
  const projects = [
    { title: 'FinTech Dashboard', category: 'Web Application', color: 'from-blue-500 to-blue-600' },
    ...
    { title: 'Healthcare Portal', category: 'Web Application', color: 'from-orange-500 to-orange-600' },
  ];
